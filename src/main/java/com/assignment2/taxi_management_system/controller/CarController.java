...
public class CarController {
    ...
    @RequestMapping(path = {"admin/cars", "/driver/cars"}, method = RequestMethod.GET)
    ...
    @RequestMapping(path = "customer/cars", method = RequestMethod.GET)
    public List<Car> getAllCarsWithDrivers(@RequestParam(value = "page", required = false) Optional<Integer> page,
                                @RequestParam(value = "limit", required = false) Optional<Integer> limit){
    ...
    @RequestMapping(path = {"admin/cars", "/driver/cars"}, method = RequestMethod.PATCH)
